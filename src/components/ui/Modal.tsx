...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        className={`relative z-10 w-full bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 ${sizeStyles[size]} ${className}`}
      >
