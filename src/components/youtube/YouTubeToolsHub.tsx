  ...
  const youtubeTools = [
    {
      ...
      route: '/youtube-tools/youtube-thumbnail-downloader',
      icon: Download,
    ...
    },
    {
      ...
      route: '/youtube-tools/youtube-timestamp-link-generator',
      icon: Clock,
    ...
    },
    {
      ...
      route: '/youtube-tools/youtube-embed-code-generator',
      icon: Code,
    ...
    },
    {
      ...
      route: '/youtube-tools/youtube-thumbnail-previewer',
      icon: Eye,
    ...
    },
    {
      ...
      route: '/youtube-tools/youtube-channel-id-finder',
      icon: AtSign,
    ...
    },
    {
      ...
      route: '/youtube-tools/youtube-tag-extractor',
      icon: Hash,
